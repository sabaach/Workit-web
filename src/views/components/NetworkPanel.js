              ...
              >
                <div className="contact-info flex items-center space-x-3">
                  <div className="contact-avatar-container relative">
                    ...
                    {isOnline ? (
                      <div className="online-badge absolute bottom-0 right-0 w-3 h-3 bg-green-500 rounded-full border-2 border-white animate-pulse"></div>
                    ) : (
                      <div className="offline-badge absolute bottom-0 right-0 w-3 h-3 bg-gray-400 rounded-full border-2 border-white"></div>
                    )}
                  </div>
                  <div className="contact-details flex-1">
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`text-xs px-2 py-1 rounded-full ${isOnline
                    ...
                    {!isOnline && (
                      <p className="contact-last-seen text-gray-500 text-xs mt-1">
                        Offline
                      </p>
                    )}
                  </div>
